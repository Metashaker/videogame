...
const collision = () => {
  targets.forEach((element => {
    ...
    if (player1.isTouching(element) && element.img.src.includes('good-taco.png')) {
      console.log("Hey")
      targets.splice(indexOfEl, 1)
      score += 1
    } else if (player1.isTouching(element) && element.img.src.includes('good-pill.png')) {
      targets.splice(indexOfEl, 1)
      score += 2
    } else if (player1.isTouching(element) && element.img.src.includes('bad-germ.png')) {
      targets.splice(indexOfEl, 1)
      score -= 2
    } else if (player1.isTouching(element) && element.img.src.includes('bad-tacoo.png')) {
      targets.splice(indexOfEl, 1)
      score -= 1
    }
  }))
